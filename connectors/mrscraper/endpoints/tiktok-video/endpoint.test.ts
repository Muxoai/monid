...
const ID = "mrscraper#tiktok/video";
const fixturesDir = fromFileUrl(new URL("./fixtures/", import.meta.url));
const INPUT = {
    body: { url: "https://www.tiktok.com/@mrbeast/video/7670199761282075935" },
};
...
Deno.test(`${ID}: the compiled schema gates the input`, async () => {
    ...
    const twin = await run({
        url: "https://www.tiktok.com/@mrbeast/video/7670199761282075935?is_from_webapp=1",
    });
