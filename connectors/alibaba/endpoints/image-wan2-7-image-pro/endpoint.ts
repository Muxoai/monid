...
import { zWan27ImageProBody } from "./schema/inputs.ts";

/**
 * Wan 2.7 Image Pro — text-to-image, image editing, multi-image reference and
...
export default defineEndpoint({
    meta: {
        ...
        notes: [
            ...
            "4K output applies to pure text-to-image only — not with input " +
            "images or image-set mode.",
    ...
    endpoint: "/v1/image/wan2.7-image-pro",
    request: {
        method: "POST",
    ...
    input: {
        schema: { body: zWan27ImageProBody },
    ...
    usage: {
        ...
        model: {
            ...
            unit: Unit.RESULT,
            label: "images",
            description: "US$0.075 per image actually generated",
